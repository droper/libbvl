...
"""Devuelve los datos financieros de los años 2011 y 2012"""

from bs4 import BeautifulSoup
from utilitarios import report_html, find_tag

def report_data_2011(rpj, trimestre, anho):
    """Funcion que obtiene los datos de los reportes financieros de la
    empresa"""
    ...
    #Report url
    url_resultados = "http://www.bvl.com.pe/jsp/ShowEEFF_new.jsp?Ano="+anho+ \
                     "&Trimestre="+trimestre+"&Rpj="+rpj+ \
                     "&RazoSoci=&TipoEEFF=GYP&Tipo1=T&Tipo2=" + \
                     "I&Dsc_Correlativo=0000&Secuencia=0"
    ...
    ###########Data de Estado Situacion financiera#########

    url_situacion_financiera = \
    "http://www.bvl.com.pe/jsp/ShowEEFF_new.jsp?Ano=" \
    +anho+"&Trimestre="+trimestre+"&Rpj="+rpj+ \
    ...
    if html:
        ...
        data['flujo_efectivo'] = \
        float(find_tag(reporte, u'Flujos de Efectivo y Equivalente al ' + \
        'Efectivo Procedente de (Utilizados en) Actividades de Operac', 6). \
        replace(',', ''))
